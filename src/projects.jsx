...
},
{
  ...
  personalProject: true,
  text: < div > Vantivities est un projet personnel que j&apos;ai réalisé en parallèle de ma dernière formation. Cette application Android permet au utilisateur de créer des activités pour se rencontrer en vrai et contient un chat. Cela m&apos;a permis de travailler sur de nombreuses choses : <ul>< li > La gestion de compte utilisateur</li><li>Un chat</li><li>Les opérations CRUD</li><li>La gestion et la sécurité d&apos;une base de données SQL</li> <li>Le déploiement d&apos;une application Android</li></ul ></div >,
},
{
